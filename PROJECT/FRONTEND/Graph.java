...
{
	//DATA MEMBERS
	public String [] cty= {"Delhi","Mumbai","Pondicherry","Surat","Chennai","Banglore","Pune","Jaipur","Cochin","Goa","Kannur","Calicut","Hyderabad","Mysoore","Trivandrum","Kolkata","UAE","Quatar"};
