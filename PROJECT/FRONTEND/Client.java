...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\HP\\Downloads\\"));
        try {
            final Image backgroundImage = javax.imageio.ImageIO.read(new File("C:\\Users\\HP\\Downloads\\New folder\\Airline-Reservation-System\\Airline-Reservation-System\\assets\\aeroplane.jpg"));
            setContentPane(new JPanel(new BorderLayout()) {
                @Override public void paintComponent(Graphics g) {
                    g.drawImage(backgroundImage.getScaledInstance(800,600,Image.SCALE_SMOOTH), 0, 0, null);
                }
            });
        } catch (IOException e) {
        ...
        TitledBorder borderTitle=BorderFactory.createTitledBorder("Log In");
        borderTitle.setTitleColor(Color.WHITE);
        loginScreen.setBorder(javax.swing.BorderFactory.createTitledBorder(borderTitle));
        ...
        jButton1.setText("Log in as Passenger");
